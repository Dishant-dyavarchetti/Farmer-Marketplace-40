...
const Footer = () => {
  ...
  return (
    <footer className="bg-text pt-12 pb-6 text-white">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Connecting verified natural farmers directly with conscious consumers through 
              trust, transparency, and traceability.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-8 h-8 bg-primary/20 hover:bg-primary/40 rounded-full flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/farmers" className="text-gray-300 hover:text-primary transition-colors">Our Farmers</Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/register" className="text-gray-300 hover:text-primary transition-colors">Join as Farmer</Link>
              </li>
            </ul>
          </div>
          ...
          {/* Help & Support */}
          <div>
            <h3 className="text-lg font-semibold mb-4 border-b border-gray-700 pb-2">Help & Support</h3>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-300 hover:text-primary transition-colors">FAQ</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-primary transition-colors">Shipping Policy</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-primary transition-colors">Return Policy</a>
              </li>
              <li>
              ...
              <li>
                <a href="#" className="text-gray-300 hover:text-primary transition-colors">Farmer Verification</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Subscribe to our newsletter to receive updates on new farmers, products, and upcoming events.
            </p>
            <form onSubmit={handleSubscribe}>
              <div className="flex mb-2">
                <input 
                  ...
                  className="px-4 py-2 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-primary text-text w-full"
                  required
                />
                <button 
                  type="submit" 
                  className="bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-r-lg transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-text"
                >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {currentYear} Farm Fresh. All rights reserved.
          </p>
          <div className="flex space-x-4">
